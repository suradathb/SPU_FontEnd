;(function (root, factory) {
  ...
  function Sparkline(element, options) {
    // Suradath
    // if (!element) {
    //   console.error('Sparkline element is not defined')
    //   return
    // }
    // Suradath
  ...
  Sparkline.prototype.draw = function (points) {
    // Check if canvas is defined Suradath
    if (!this.canvas) {
      // console.error('Canvas is not defined.')
      return
    }

    // Check if canvas has a width property Suradath
    if (!this.canvas.width) {
      console.error('Canvas width is not defined.')
      return
    }
    points = points || []
    this.points = points
